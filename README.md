...
5. [Inserción de Datos](#5-inserción-de-datos)
   - [Autores (5 ejemplos)](#autores-5-ejemplos)
   - [Libros](#libros)
   - [Préstamos](#préstamos)
6. [Consultas Básicas](#6-consultas-básicas)
   - [Listar todos los libros con su autor correspondiente](#listar-todos-los-libros-con-su-autor-correspondiente)
   - [Mostrar los préstamos que aún no tienen fecha de devolución](#mostrar-los-préstamos-que-aún-no-tienen-fecha-de-devolución)
   - [Obtener los autores que tienen más de un libro registrado](#obtener-los-autores-que-tienen-más-de-un-libro-registrado)
7. [Consultas con Agregación](#7-consultas-con-agregación)
   - [Calcular el número total de préstamos realizados](#calcular-el-número-total-de-préstamos-realizados)
   - [Obtener el número de libros prestados por cada usuario](#obtener-el-número-de-libros-prestados-por-cada-usuario)
8. [Modificación de Datos](#8-modificación-de-datos)
   - [Actualizar la fecha de devolución de un préstamo pendiente](#actualizar-la-fecha-de-devolución-de-un-préstamo-pendiente)
   - [Eliminar un libro y comprobar el efecto en la tabla de préstamos](#eliminar-un-libro-y-comprobar-el-efecto-en-la-tabla-de-préstamos)
9. [Creación de Vistas](#9-creación-de-vistas)
10. [Funciones y Consultas Avanzadas](#10-funciones-y-consultas-avanzadas)
11. [Exportación e Importación de Datos](#11-exportación-e-importación-de-datos)
